...
const BRAND_SUMMARIES: Record<string, string> = {
  '洋葱':            '**动画直观**、**校内同步**是核心竞争力，"从小学物理"**实验吸引力强**、**孩子自主完课率高**；购买动因偏向**品牌信任/老板学霸光环**而非课程卖点击中；**晦涩词语孩子不能理解**、**不够口语化**是关键体验折损点。',
  'NB虚拟实验室':    '**触屏模拟实验安全便捷**、**终身制低价**受认可，覆盖学段/学科/教材广泛，内容制作精细；**缺少讲解和引导**，更多是孩子自己操作，模拟与真实实验的落差是产品天然限制。',
  '万物指南':        '**吴姥姥权威背书**建立信任，内容**短而精、废话少**是差异化壁垒；物化捆绑售卖策略有效；**看完不知道孩子吸收了多少**是续费最大阻力。',
  '妙懂':            '**AR好玩**是强记忆点，有**题库**辅助；但**太正式，不是小孩能接受的语气**，"孩子看着感觉像学习"；**应试感知偏差**抑制启蒙场景的新用户转化。',
  '学而思':          '**真人老师反馈互动**、**动手实验**比纯视频有吸引力；但老师讲解**没用孩子的语言**、以参赛为目的**性价比不高**（进阶需再付费），**课程停运**带来严重信任损伤。',
...
const CROSS_BRAND_CONCLUSIONS: { text: string; color: string }[] = [
  ...
  {
    text: '所有竞品共同短板：**不用孩子的语言讲解**——NB实验室缺讲解、学而思/赛先生"没用孩子语言"、妙懂"太正式，不是小孩能接受的语气"；这正是洋葱做**学科启蒙**最核心的差异化机会。',
    color: '#C06090',
  },
  {
    text: '所有竞品共同缺失：**效果外化**——万物指南"看完不知道吸收多少"、三五小星"只看到几颗星"、多位家长反映"不知道怎么看出孩子的变化"；谁先解决**让家长看见启蒙效果**，谁就占据决定性优势。',
    color: '#8B6DB0',
  },
];
